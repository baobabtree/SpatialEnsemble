...
public class semiSpatialCluster {
    ...
    public static void main(String[] args) {
        ...
        String cluster_file_path = "Data/BigStone/cluster.txt";//"Data/toyExample/toy.cluster.txt";
        String graph_file_path = "Data/BigStone/graph.txt";//"Data/toyExample/toy.graph.txt";
